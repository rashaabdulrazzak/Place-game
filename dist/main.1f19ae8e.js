...
var CONTRACT_NAME = "dev-1646319959838-77484121657334" || "dev-1646319959838-77484121657334";
/* TODO: fill this in! */
  ...
  switch (env) {
    ...
    case "local":
      return {
        ...
        keyPath: "".concat("/home/rasha", "/.near/validator_key.json"),
...
window.nearInitPromise = connect().then(updateUI).then(loadBoardAndDraw).catch(console.error); // NEAR Place application Code
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40155" + '/');
